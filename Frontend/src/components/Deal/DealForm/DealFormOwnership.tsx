...
export const DealFormOwnership: React.FC<DealFormOwnershipProps> = ({ formData, onChange, validationErrors = {} }) => {
  ...
  return (
    <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
      <div className="flex items-center space-x-3 mb-6 pb-3 border-b border-gray-100">
        ...
        <div>
          <h2 className="text-base font-semibold text-gray-900">Ownership & Tracking</h2>
      ...
      <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="p-3 bg-gradient-to-r from-green-100 to-emerald-100 rounded-lg border-2 border-green-300">
                ...
                <div className="text-sm text-green-800 space-y-1">
                  <div><span className="font-bold">{formData.hrmsConnection?.recruited || 'Sarah Lee'} (CFO)</span> was recruited from <span className="font-bold">TechStart</span> on <span className="font-bold">Nov 14, 2024</span></div>
              ...
              <button className="w-full px-4 py-2.5 bg-orange-600 text-white rounded-lg hover:bg-orange-700 text-sm font-medium transition-colors shadow-sm">
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-2 mb-3">
            ...
            <button className="inline-flex items-center px-3 py-1 bg-gray-100 text-gray-700 text-sm font-medium rounded-full hover:bg-gray-200 transition-colors">
              + Add Tag
            </button>
          </div>
