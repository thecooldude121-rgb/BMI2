  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-600 mt-1">Control notifications within the application</p>
      </div>
        ...
        {Object.entries(notifications).map(([key, value]) => (
          <div key={key} className="flex items-center justify-between py-3 border-b border-gray-200">
            <div>
              ...
              <div className="text-xs text-gray-500">Show in-app alerts for this activity</div>
            </div>
