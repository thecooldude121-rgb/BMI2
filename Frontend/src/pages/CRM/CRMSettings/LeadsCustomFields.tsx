...
const LeadsCustomFields: React.FC = () => {
  const fields = [
    { name: 'Lead Source', type: 'Dropdown', required: true },
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <div>
          <h2 className="text-2xl font-bold text-gray-900">Leads Custom Fields</h2>
          <p className="text-sm text-gray-600 mt-1">Add custom fields to your leads</p>
        </div>
